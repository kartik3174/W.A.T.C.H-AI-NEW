...
export const metadata: Metadata = {
  title: "Register | W.A.T.C.H",
  description: "Create your account for the Wildlife AI Tracking and Conservation Hub",
}
      ...
      <div className="card relative z-10 w-full max-w-md p-6 sm:p-8">
        ...
        <div className="flex flex-col items-center space-y-2 mb-6">
          ...
          <p className="text-sm text-muted-foreground text-center font-semibold">
            Join the Wildlife AI Tracking and Conservation Hub
          </p>
        </div>
