...
export default function TrackingPage() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6 relative">
      ...
      <PageHeader
        title={t("tracking.title") || "Wildlife Tracking & Drone Response Command Center"}
        description={t("tracking.description") || "Monitor wildlife locations and manage autonomous drone response system in real-time"}
      />
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-card rounded-lg border border-border p-4 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-foreground">{t("tracking.map.title") || "Reserve Tracking Map"}</h3>
              <Button
              ...
              >
                ...
                {t("simulate.breach") || "Simulate Breach"}
              </Button>
            </div>
            <TrackingMap />
          </div>
