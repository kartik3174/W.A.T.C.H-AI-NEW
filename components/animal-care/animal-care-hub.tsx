    ...
    <div className="space-y-6">
      <Tabs defaultValue="health" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3 bg-card border-border">
          <TabsTrigger value="health" className="text-foreground data-[state=active]:bg-secondary">{t("health.updates")}</TabsTrigger>
          <TabsTrigger value="recommendations" className="text-foreground data-[state=active]:bg-secondary">{t("care.recommendations")}</TabsTrigger>
          <TabsTrigger value="history" className="text-foreground data-[state=active]:bg-secondary">{t("veterinary.history")}</TabsTrigger>
        </TabsList>
