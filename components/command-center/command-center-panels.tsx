...
export function RightPanelAlerts() {
  ...
  return (
    <CommandCenterCard title={t("active.alerts") || "Active Alerts"} icon={AlertTriangle}>
...
export function RightPanelInsights() {
  ...
  return (
    <CommandCenterCard title={t("ai.insights") || "AI Insights"} icon={Activity}>
      <div className="space-y-3">
...
export function OperationalMetrics() {
  const { t } = useLanguage()
  return (
    <CommandCenterCard title={t("operational.status") || "Operational Status"} icon={Zap}>
      <div className="grid grid-cols-2 gap-3">
        <MetricCard label={t("total.animals") || "Animals Tracked"} value="47" icon={Users} />
        <MetricCard label={t("drones.active") || "Drones Active"} value="6" icon={Zap} />
        <MetricCard label={t("active.alerts") || "Active Alerts"} value="3" icon={AlertTriangle} />
        <MetricCard label={t("system.status") || "System Health"} value="98" unit="%" />
      </div>
    </CommandCenterCard>
  )
}
...
export function BottomPanelDroneMissions() {
  ...
  return (
    <CommandCenterCard title={t("drone.missions") || "Drone Mission Status"} icon={Zap} className="w-full">
...
export function BottomPanelActivityLog() {
  ...
  return (
    <CommandCenterCard title={t("activity.log") || "Activity Log"} icon={Activity}>
